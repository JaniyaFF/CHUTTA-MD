...
SESSION_ID: process.env.SESSION_ID === undefined ? 'VAJIRA-MD=iccHBJ6A#t7bdwxQZ7FrvLv7EqER0CBrhVy69zdlUV1Zo-J10YEM' : process.env.SESSION_ID,
OWNER_NUMBER: process.env.OWNER_NUMBER === undefined ? '94772041602' : process.env.OWNER_NUMBER,   
